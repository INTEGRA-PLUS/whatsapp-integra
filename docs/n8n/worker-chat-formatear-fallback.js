// ---------------------------------------------------------------
// 02 · Chatbot Worker (Ollama), nodo `Formatear fallback`
//
// Mismo contrato que `Formatear respuesta`, pero marcado como
// degradado para poder medir cuánto tráfico se va al modelo de
// respaldo. Se cambia a la vez que aquél o el traspaso deja de
// funcionar justo cuando el modelo primario está caído.
//
